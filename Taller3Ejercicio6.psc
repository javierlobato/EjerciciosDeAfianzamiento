	...
	Repetir
		...
		Segun opcion Hacer
				...
				SiNo
					...
					Para j<-0 Hasta 1  Hacer
						...
						Si telefono = listatelefono[j] Entonces
							Escribir "Numero ", telefono ," ya existe";
			...
			2: 
				...
				Escribir "1. ",listaNombres[0],", Núnmero: ",listatelefono[0],", Org: ",listaorganizacion[0];
				Escribir "2. ",listaNombres[1],", Núnmero: ",listatelefono[1],", Org: ",listaorganizacion[1];
				Escribir "3. ",listaNombres[2],", Núnmero: ",listatelefono[2],", Org: ",listaorganizacion[2];
			...
			3:
				...
				Repetir
					...
					Escribir "1. ",listaNombres[0],"-",listatelefono[0],"-",listaorganizacion[0];
					Escribir "2. ",listaNombres[1],"-",listatelefono[1],"-",listaorganizacion[0];
					Escribir "3. ",listaNombres[2],"-",listatelefono[2],"-",listaorganizacion[0];
					Escribir "[0]. -SALIR";
					Leer opcion2;
