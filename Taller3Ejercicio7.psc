	...
	Repetir
		...
		Segun opcion Hacer
			1:
				...
				Escribir "";
				Escribir "[1]. Nombre: ",nombreCliente[0],", Marca: ",marca[0],", Placa: ",placa[0],", Teléfeno: ",telefono[0] ;
				Escribir "[2]. Nombre: ",nombreCliente[1],", Marca: ",marca[1],", Placa: ",placa[1],", Teléfono: ",telefono[1] ;
				Escribir "[3]. Nombre: ",nombreCliente[2],", Marca: ",marca[2],", Placa: ",placa[2],", Teléfono: ",telefono[2] ;
				Escribir "[4]. Nombre: ",nombreCliente[3],", Marca: ",marca[3],", Placa: ",placa[3],", Teléfono: ",telefono[3] ;
				Escribir "[5]. Nombre: ",nombreCliente[4],", Marca: ",marca[4],", Placa: ",placa[4],", Teléfono: ",telefono[4] ;
				Escribir "[0]. -SALIR-";
				leer opcion2;
